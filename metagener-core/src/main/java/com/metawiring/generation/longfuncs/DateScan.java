 ...
 *
 * <p>
 *     This function considers the population size to determine the stepping of timestamps,
 *     providing an even increment in date time from the first to the last sample. This requires
 *     the input to be the sample id, not the entity id, even though this function is entity def aware.
 * </p>
 */
public class DateScan implements LongUnaryFieldFunction, EntityDefAware {
    ...
    public DateScan(String minSpec, String maxSpec) {
    ...
    private void calculateScaleFactor() {
        ...
        scaleFactor = ((double) totalSpan ) /((double) entityDef.getPopulationSize());
    }
