...
public enum FieldType {
    ...
    type_timestamp(DateTime.class, "timestamp",BoxedTimeStamp.class),
    ...
    Class<?> clazz;
    String typeName;
    Class<? extends FieldFunction> defaultFieldFunction;

    FieldType(Class<?> clazz, String typeName, Class<? extends FieldFunction> defaultFieldFunctionClass) {
        this.clazz = clazz;
    ...
    public Class<? extends FieldFunction> getDefaultFieldFunction() { return defaultFieldFunction; }
